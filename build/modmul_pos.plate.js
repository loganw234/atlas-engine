"use strict";
/* GENERATED by atlas-engine from positives/modmul.pos.mjs - do not edit */
Atlas.registerPlate({
  id: "modmul_pos",
  name: "modmul_pos (emitted)",
  roman: "E",
  accent: "#f2a0ff",
  tex: "", plain: "emitted by atlas-engine",
  caption: "Emitted by atlas-engine; the positive is the source.",
  cam: {"dist":3.2,"pitch":0.35,"tgtY":0,"rot":0.04},
  gain: 0.8,
  params: [
  {
    "kind": "lever",
